...
import com.dew.item.utils.buildSXItem
import com.dew.item.utils.getSXItem
import com.dew.item.utils.takeSXItem
...
object Bank {
    ...
    fun open(player: Player) {
        player.openMenu<Basic>("&a&l 个人终端  &f(&e${has(player)}&f)".colored()) {
            map(
                "#########",
                "##A#B#C##",
                "#########",
